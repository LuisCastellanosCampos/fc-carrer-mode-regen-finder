...
Próximamente las instrucciones detalladas para levantar el entorno de desarrollo con Docker o de forma manual. | Detailed instructions to set up the development environment with Docker or manually coming soon.
